...
# count each row in column A
# dataframe.count

  * The net total amount of "Profit/Losses" over the entire period
# sum each row in column B

  * The average of the changes in "Profit/Losses" over the entire period
# calculate average change - when row 2 is subtracted from row 1. The average of those results
...
# percentage of votes for unique candidate (wrestling_function_activity: win_percent = (wins / total_matches) * 100)

  * The total number of votes each candidate won
# number of votes for unique candidate
votes.counts

  * The winner of the election based on popular vote.
# candidate with highest percentage (wrestling_function_activity: win_percent = (wins / total_matches) * 100)
